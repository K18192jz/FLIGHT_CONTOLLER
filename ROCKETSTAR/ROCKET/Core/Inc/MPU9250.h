 ...
 * MPU9250.h
 *
 * Adapted for MPU6500 (same accel/gyro core & register map as MPU9250,
 * no magnetometer). Struct/file names kept as "MPU9250" for continuity
 * with the reference driver this was based on.
 */
...
// Defines
// Genuine MPU6500 answers 0x70 on WHO_AM_I. Some MPU6500 die revisions /
// clones answer 0x71 (same as MPU9250, since it's the same silicon) --
// accept either so you don't get a false "not detected" on a real part.
#define WHO_AM_I_6500_ANS_A 0x70
#define WHO_AM_I_6500_ANS_B 0x71
