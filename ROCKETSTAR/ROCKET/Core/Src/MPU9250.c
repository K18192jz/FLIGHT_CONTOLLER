 ...
 * MPU9250.c
 *
 * Adapted for MPU6500. Register-level behavior is identical to the
 * MPU9250's accel/gyro core -- the only functional change from the
 * original reference driver is the WHO_AM_I check in MPU_begin().
 */
